...
// 示例有延时的任务
function exampleDelayedTask(message) {
    return function () {
        console.log(message);
    };
}
...
// 调度示例有延时的任务
scheduleDelayedTask(exampleDelayedTask('Delayed Task 1'), 3000);
scheduleDelayedTask(exampleDelayedTask('Delayed Task 2'), 2000);
scheduleDelayedTask(exampleDelayedTask('Delayed Task 3'), 1000);
